...
with open(
    "/Users/iansnyder/Desktop/Projects/Image_Classification_NN/Image_classification_numPyNN/src/nn/gpt/input.txt",
    "r",
    encoding="utf-8",
) as f:
    text = f.read()
...
class GPTLargeLangModel(nn.Module):
    def __init__(self):
        super().__init__()
...
checkpoint = torch.load("Image_classification_numPyNN/src/models/GPT_3M.pt")
...
with open("Image_classification_numPyNN/src/nn/gpt/outputs/outputlarge.txt", "w") as f:
    f.write(out)
